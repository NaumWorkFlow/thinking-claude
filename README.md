...
| **Claude chat** | ядро | вставить `CLAUDE.md` в инструкции claude.ai-проекта или `portable-system-prompt.md` первым сообщением. Память/Overseer тут не нужны |
...
- **Еженедельный Overseer** (scheduled, понедельник) — читает реестр и предлагает что подтвердить/убрать/упростить.
